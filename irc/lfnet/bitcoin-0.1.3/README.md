# bitcoin-0.1.3 — IRC-fixed client (LFnet)
...
It is exactly **`bitcoin-0.1.3/src` + `patches/code/lfnet/0.1.3.patch`** applied.
...
```sh
cd bitcoin-0.1.3/src && patch -p1 < ../../patches/code/lfnet/0.1.3.patch
```
