# bitcoin-0.1.0 — IRC-fixed client (Freenode)
...
It is exactly **`bitcoin-0.1.0/src` + `patches/code/freenode/0.1.0.patch`** applied.
...
```sh
cd bitcoin-0.1.0/src && patch -p1 < ../../patches/code/freenode/0.1.0.patch
```
